...
export default function Hero() {
  return (
    <section className="relative flex items-center overflow-hidden pt-40 pb-16 bg-[#EEF4FB]">
      {/* Subtle dot pattern */}
      <div
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16 w-full grid lg:grid-cols-[2fr_3fr] gap-10 lg:gap-14 items-center">
        {/* Left: headline + CTAs */}
        <div>
          {/* Logo — large and prominent for accessibility */}
          <div className="mb-8">
            <Image
          ...
          <div className="flex flex-col sm:flex-row gap-3 mb-6">
            ...
            <a
              href="tel:9544244240"
              className="flex items-center justify-center gap-2 bg-transparent border-2 border-[#005FDE] text-[#005FDE] hover:bg-[#005FDE] hover:text-white px-8 py-3.5 rounded-full font-bold text-sm transition-all whitespace-nowrap"
            >
              <Phone size={16} />
              (954) 424-4240
            </a>
